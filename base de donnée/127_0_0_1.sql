...
--
-- Hôte : 127.0.0.1
-- Généré le : mar. 02 mai 2023 à 16:55
...
CREATE TABLE `chambre` (
  ...
  `degre_confort` varchar(20) DEFAULT NULL,
...
CREATE TABLE `client` (
  `adress_client` varchar(40) DEFAULT NULL,
...
CREATE TABLE `hotel` (
  ...
  `categorie_hotel` varchar(20) DEFAULT NULL,
  `nom_hotel` varchar(20) DEFAULT NULL,
  `adresse_hotel` varchar(35) DEFAULT NULL,
...
CREATE TABLE `station` (
  `num_station` int(11) DEFAULT NULL,
  `nom_station` varchar(25) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
ALTER TABLE `reservation`
  ADD KEY `fkch` (`num_chambre`),
  ADD KEY `fknclien` (`num_client`);
...
--
ALTER TABLE `reservation`
  ADD CONSTRAINT `fkch` FOREIGN KEY (`num_chambre`) REFERENCES `chambre` (`num_chambre`),
  ADD CONSTRAINT `fknclien` FOREIGN KEY (`num_client`) REFERENCES `client` (`num_client`);
--
-- Base de données : `personna1`
--
CREATE DATABASE IF NOT EXISTS `personna1` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `personna1`;
...
CREATE TABLE `groupe` (
  `gro_num` int(11) NOT NULL,
  `gro_libelle` varchar(40) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `personne` (
  `per_num` int(11) NOT NULL,
  `per_nom` varchar(40) DEFAULT NULL,
  `per_prenom` varchar(40) DEFAULT NULL,
  `per_adresse` varchar(40) DEFAULT NULL,
  `per_ville` varchar(40) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
ALTER TABLE `appartient`
  ADD KEY `fkgrp1e` (`gro_num`),
  ADD KEY `fkper1` (`per_num`);
...
--
ALTER TABLE `appartient`
  ADD CONSTRAINT `fkgrp1e` FOREIGN KEY (`gro_num`) REFERENCES `groupe` (`gro_num`),
  ADD CONSTRAINT `fkper1` FOREIGN KEY (`per_num`) REFERENCES `personne` (`per_num`),
  ADD CONSTRAINT `fkpers1` FOREIGN KEY (`per_num`) REFERENCES `personne` (`per_num`);
--
...
('root', '[{\"db\":\"poei\",\"table\":\"personne\"},{\"db\":\"personna1\",\"table\":\"appartient\"},{\"db\":\"hotel\",\"table\":\"reservation\"},{\"db\":\"poei\",\"table\":\"vehicule\"},{\"db\":\"hotel\",\"table\":\"hotel\"},{\"db\":\"hotel\",\"table\":\"client\"},{\"db\":\"personna1\",\"table\":\"personne\"}]');
...
('root', '2023-05-02 14:45:42', '{\"Console\\/Mode\":\"show\",\"lang\":\"fr\"}');
